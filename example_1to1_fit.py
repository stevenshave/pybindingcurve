...
# Experimental data
xcoords = np.array([0.,   20.,   40.,   60.,   80.,  100.,  120.,   140.,  160.,   180.,  200.])
...
fitted_system, fit_accuracy = mySystem.fit(system_parameters, {'kdpl': 0}, ycoords, 'pl')
...
fitted_system['p'] = np.linspace(0, np.max(xcoords), num=20)
